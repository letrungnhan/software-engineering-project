        ...
        <Helmet title={info.name} style={{ position: 'relative' }}>
            <Layout>
                ...
                <Box sx={{ p: 3 }}>
                    ...
                    <Backdrop open={openEdit} type={"button"} onClick={() => setOpenEdit(false)} sx={{ zIndex: 999 }} />
                    <div className={`${openEdit ? 'open' : 'hidden'} popup`}>
                        ...
                        <div className={"popup__body"}>
                            ...
                            <div className={"popup__body__song"}>
                                ...
                                }} placeholder='Mô tả' onChange={(e) => setDescription(e.target.value)} defaultValue={description}>
